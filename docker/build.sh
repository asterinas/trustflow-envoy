...
IMAGE_TAG=${DOCKER_REG}/trustflow-envoy-ubuntu22.04:${VERSION}
LATEST_TAG=${DOCKER_REG}/trustflow-envoy-ubuntu22.04:latest
echo -e "Building ${GREEN}${IMAGE_TAG}${NO_COLOR}"
cd .. && docker build . -f docker/Dockerfile -t ${IMAGE_TAG}
